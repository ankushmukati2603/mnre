    ...
    axios.get('/admin/get-content').then(response => response.data).catch(error => {
        ...
        if (data.status == "Success") {
            ...
            for (var i = 0; i < content.length; i++) {
                ...
                $('.banners_multiple').append(`
                    <div class="column is-4">
                    <figure class="image">
                        <img class="item__image--banner" src="${itm.BANNER_IMAGE.LOCATION}" alt="">
                        <div class="field">
                            <div class="control">
...
$('.homePageBannerSectionSave').click(function () {
...
$('.isapagesave').click(function () {
    ...
    var image = isapage_file.file
    var fd = new FormData()
    fd.append('image', image)
    fd.append('summary', summary)
    axios.post('/admin/isa/overview', fd, {
        headers: {
            "Content-Type": "multipart/form-data"
        }
    }).then(response => response.data).catch(error => {
